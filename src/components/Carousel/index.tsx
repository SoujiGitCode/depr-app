...
const MyCarousel = ({ isMobile }: { isMobile: boolean }) => {
    ...
    const paragraphOne = "Para crear una solicitud debe ingresar sus datos personales e información de la escuela donde cursó el grado a ser considerado para la emisión de sus certificado de graduación."
